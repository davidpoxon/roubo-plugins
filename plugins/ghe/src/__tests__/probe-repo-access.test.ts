...
describe("probeRepoAccess", () => {
  ...
  it("returns accessible:false with status and message on a 403 access-restriction", async () => {
    const message =
      "Although you appear to have the correct authorization credentials, the `int3nt` organization has enabled access restrictions, meaning that data access to third-parties is limited.";
